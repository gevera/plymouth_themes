...
Xiaomi à la Windows 10 boot splash theme for Plymouth
...
Untar the downloaded archive file
    ...
    tar xvaf xiaomi10.tar.gz

**Step 2**
Copy *xiaomi10* folder to */usr/share/plymouth/themes*
### Option 1
Manually 

    sudo cp -vr xiaomi10 /usr/share/plymouth/themes/
...
To make sure that the theme is indeed installed execute
    ...
    sudo update-alternatives --install /usr/share/plymouth/themes/default.plymouth default.plymouth /usr/share/plymouth/themes/xiaomi10/xiaomi10.plymouth 100

Choose the *xiaomi10* theme to be activated
