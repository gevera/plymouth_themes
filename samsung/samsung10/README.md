dell10 Plymouth Theme
=======================

Samsung à la Windows 10 boot splash theme for Plymouth
...
Untar the downloaded archive file
    ...
    tar xvaf samsung10.tar.gz

**Step 2**
Copy *samsung10* folder to */usr/share/plymouth/themes*
### Option 1
Manually 

    sudo cp -vr samsung10 /usr/share/plymouth/themes/
...
To make sure that the theme is indeed installed execute
    ...
    sudo update-alternatives --install /usr/share/plymouth/themes/default.plymouth default.plymouth /usr/share/plymouth/themes/samsung10/samsung10.plymouth 100

Choose the *samsung10* theme to be activated
