huawei10 Plymouth Theme
=======================

Huawei à la Windows 10 boot splash theme for Plymouth
...
Untar the downloaded archive file
    ...
    tar xvaf huawei10.tar.gz

**Step 2**
Copy *huawei10* folder to */usr/share/plymouth/themes*
### Option 1
Manually 

    sudo cp -vr huawei10 /usr/share/plymouth/themes/
...
To make sure that the theme is indeed installed execute
    ...
    sudo update-alternatives --install /usr/share/plymouth/themes/default.plymouth default.plymouth /usr/share/plymouth/themes/huawei10/huawei10.plymouth 100

Choose the *huawei10* theme to be activated
