think10 Plymouth Theme
=======================

Thinkpad à la Windows 10 boot splash theme for Plymouth
...
**Step 2**
Copy *think10* folder to */usr/share/plymouth/themes*
### Option 1
Manually 
...
To make sure that the theme is indeed installed execute
    ...
    sudo update-alternatives --install /usr/share/plymouth/themes/default.plymouth default.plymouth /usr/share/plymouth/themes/think10/think10.plymouth 100

Choose the *think10* theme to be activated
