...
Dell à la Windows 10 boot splash theme for Plymouth
...
Untar the downloaded archive file
    ...
    tar xvaf dell10.tar.gz

**Step 2**
Copy *dell10* folder to */usr/share/plymouth/themes*
### Option 1
Manually 
...
Choose the *dell10* theme to be activated
